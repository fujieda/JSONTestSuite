   ...
   "Json.NET 12.0.3":
       {
           ...
           "commands":["/usr/bin/dotnet", os.path.join(PARSERS_DIR, "test_Json.NET/bin/Release/netcoreapp3.1/publish/test_Json.NET.dll")]
       },
   "Jil 2.17.0":
       {
           "url":"https://github.com/kevin-montrose/Jil",
           "commands":["/usr/bin/dotnet", os.path.join(PARSERS_DIR, "test_Jil/bin/Release/netcoreapp3.1/publish/test_Jil.dll")]
       },
   "DynamicJson 1.2.0":
       {
           "url":"https://github.com/neuecc/DynamicJson",
           "commands":["/usr/bin/dotnet", os.path.join(PARSERS_DIR, "test_DynamicJson/bin/Release/netcoreapp3.1/publish/test_DynamicJson.dll")]
       },
   "Utf8Json 1.7.3":
       {
           "url":"https://github.com/neuecc/Utf8Json",
           "commands":["/usr/bin/dotnet", os.path.join(PARSERS_DIR, "test_Utf8Json/bin/Release/netcoreapp3.1/publish/test_Utf8Json.dll")]
       },
   "DynaJson 2.0.0":
       {
           "url":"https://github.com/fujieda/DynaJson",
           "commands":["/usr/bin/dotnet", os.path.join(PARSERS_DIR, "test_DynaJson/bin/Release/netcoreapp3.1/publish/test_DynaJson.dll")]
       },
   "System.Text.Json 4.7.2":
       {
           "url":"https://docs.microsoft.com/en-us/dotnet/api/system.text.json",
           "commands":["/usr/bin/dotnet", os.path.join(PARSERS_DIR, "test_SystemTextJson/bin/Release/netcoreapp3.1/publish/test_SystemTextJson.dll")]
       }
}
